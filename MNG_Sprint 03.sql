...
select transaction.id as idTransaction,data_user.name as userName,data_user.surname as userSurname,credit_card.iban as ibanCreditCard,company.company_name as companyName
from transaction
